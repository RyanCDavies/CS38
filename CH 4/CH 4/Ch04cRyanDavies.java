...
import java.util.*; // dont do this on the test
...
public class Ch04cRyanDavies
{
    ...
    public static void petFood( )
    {
        ...
        switch(foodGrade)
        {
            case 'a': //ref: pg164 Multi Value case is same as case 'a', 'A':
            case 'A':
    ...
    public static void squares( )
    {
        ...
        for (number = 1; number <= 10; number++)
        {
            ...
            switch(number)
            {
              case 1,2,3 ->  table.setPenColor(Draw.BLACK);
              case 4,5,6 ->  table.setPenColor(Draw.BLUE);
              case 7,8,9 ->  table.setPenColor(Draw.RED);
              default    ->  table.setPenColor(Draw.BLUE);
            }
    ...
    public static void spookyEyes()
    {
        ...
        for(int count=1; count<=num; count++)
        {
            ...
            if(x0 >= 200 && y0 >= 200)
                quad.setPenColor(Draw.YELLOW);
            else if(x0 <= 200 && y0 <= 200)
                quad.setPenColor(Draw.CYAN);
            else if(x0 >= 200 && y0 <= 200)
                quad.setPenColor(Draw.GREEN);
            else
                quad.setPenColor(Draw.PINK);

            //Draw pair of eyeballs. How do we keep the eyes inside the screen
            quad.filledCircle(x0,y0,  width);
            quad.filledCircle(x0+20,y0,  width);
            quad.setPenColor();

            //draw both pupils
            quad.filledCircle (x0, y0, width/4 );
            quad.filledCircle( x0 + 20, y0, width/4);
            quad.pause(250);
        }
    }
